...
VENDOR_PRESETS: Final[dict[str, dict[str, str]]] = {
    "panasonic_heishamon": {
        ...
        "hph_ctrl_write_powerful_mode": "select.panasonic_heat_pump_main_powerful_mode_time",
        "hph_ctrl_write_active_zones": "select.panasonic_heat_pump_main_zones_state",
        "hph_ctrl_write_bivalent_mode": "",
        "hph_ctrl_write_z1_heat_shift": "number.panasonic_heat_pump_main_z1_heat_request_temp",
        "hph_ctrl_write_z2_heat_shift": "number.panasonic_heat_pump_main_z2_heat_request_temp",
        "hph_ctrl_write_heating_cutoff": "number.panasonic_heat_pump_main_heating_off_outdoor_temp",
        "hph_ctrl_write_max_pump_duty": "number.panasonic_heat_pump_main_max_pump_duty",
        "hph_ctrl_write_room_heat_delta": "number.panasonic_heat_pump_main_heat_delta",
    ...
    "panasonic_heishamon_aquarea": {
        ...
        "hph_ctrl_write_powerful_mode": "select.aquarea_main_powerful_mode_time",
        "hph_ctrl_write_active_zones": "select.aquarea_main_zones_state",
        "hph_ctrl_write_bivalent_mode": "",
        "hph_ctrl_write_z1_heat_shift": "number.aquarea_main_z1_heat_request_temp",
        "hph_ctrl_write_z2_heat_shift": "number.aquarea_main_z2_heat_request_temp",
        "hph_ctrl_write_heating_cutoff": "number.aquarea_main_heating_off_outdoor_temp",
        "hph_ctrl_write_max_pump_duty": "number.aquarea_main_max_pump_duty",
        "hph_ctrl_write_room_heat_delta": "number.aquarea_main_heat_delta",
...
NUMBER_HELPERS: Final[dict[str, dict[str, Any]]] = {
    ...
    "hph_advisor_standby_max_kwh": {"name": "Advisor — standby max (kWh/day)",
                                      "min": 0.1, "max": 5.0, "step": 0.05, "initial": 0.4,
